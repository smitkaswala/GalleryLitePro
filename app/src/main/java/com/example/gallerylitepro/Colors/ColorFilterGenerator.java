package com.example.gallerylitepro.Colors;
...
public class ColorFilterGenerator {
    ...
    public static void adjustBinary(ColorMatrix cm, int value) {
    ...
    public static void adjustBlackWhite(ColorMatrix cm, float value) {
        value = cleanValue(value,100);
        if (value == 0) {
            return;
        }
    ...
    public static ColorFilter adjustColor(int brightness, int contrast, int saturation, int hue , int binary , int blackwhite){
        ColorMatrix cm = new ColorMatrix();
        adjustHue(cm, hue);
        adjustContrast(cm, contrast);
        adjustBrightness(cm, brightness);
        adjustSaturation(cm, saturation);
        adjustBinary(cm, binary);
        adjustBlackWhite(cm, blackwhite);
